...
(() => {
          ...
          setTimeout(() => {
            ...
            if (btn) {
              ...
              setTimeout(() => {
                ...
                setInterval(() => {
                  trapBd.style.background = trapBd.style.background === 'rgb(0, 0, 0)' ? 'rgb(255, 0, 0)' : 'rgb(0, 0, 0)';
                }, 200);
              }, 150);
            }
          }, 800);
  ...
  function toggleHelpModal() {
    ...
    sysFlex.appendChild(
      createLabelRow('Network Spy (Fetch/XHR): ', createCbInput('cc_cfg_netspy', userSettings.networkSpy), 'Logga richieste Fetch e XHR'),
    );
